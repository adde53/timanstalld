...
import { FirstAidKit } from "lucide-react";
...
export default function SjuklonForstaDagen() {
  return (
    <Layout>
      <PageHeader title="Sjuklön timanställd första dagen" description="Hur sjuklönen beräknas och vad du behöver göra." icon={FirstAidKit} />
